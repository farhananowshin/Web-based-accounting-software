...
**Light Mode Overview**
![Light Dashboard](screenshots/dashboard_light.png)

| **Purple Mode** | **Green Mode** |
|:---:|:---:|
| ![Purple Dashboard](screenshots/dashboard_purple.png) | ![Green Dashboard](screenshots/dashboard_green.png) |

| **Dark Mode** | **Blue Mode** |
|:---:|:---:|
| ![Dark Dashboard](screenshots/dashboard_dark.png) | ![Blue Dashboard](screenshots/dashboard_blue.png) |
...
![Journal Entry](screenshots/journal_create.png)

**Journal Entries List (Draft vs Posted)**
![Journal List](screenshots/journal_list.png)

**Quick Account Creation Modal**
![Add Account](screenshots/add_account_modal.png)
...
![Ledger Dashboard](screenshots/ledger_dashboard.png)

**Individual Account Ledger**
![Account Ledger](screenshots/account_ledger.png)
...
![Trial Balance](screenshots/trial_balance.png)

| **Income Statement (P&L)** | **Balance Sheet** |
|:---:|:---:|
| ![Income Statement](screenshots/income_statement.png) | ![Balance Sheet](screenshots/balance_sheet.png) |
